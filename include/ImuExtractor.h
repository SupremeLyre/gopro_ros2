...
public:
  ...
  void writeImuData(rosbag2_cpp::Writer& bag, uint64_t end_time, const std::string& imu_topic);
  void writeGpsData(rosbag2_cpp::Writer& bag, uint64_t end_time, const std::string& gps_topic);
